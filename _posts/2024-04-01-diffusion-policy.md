...
* Take MSE of the predicted noise and the actual pure Gaussian noise that was used in the second step while using equation 7. Take its gradient and backpropagate it using the optimizer.
